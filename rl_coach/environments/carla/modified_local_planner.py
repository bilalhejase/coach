...
class ModifiedLocalPlanner(object):
    ...
    def __init__(self, vehicle,  buffer_size, opt_dict=None):
        """
    ...
    def run_step(self, debug=True):
        ...
        #     d2wp = 8
        #     d2goal = 10000
        #     curr_wp = carla.Waypoint(
        #         carla.Transform(carla.Location(x=0, y=0, z=1), carla.Rotation(pitch=0, yaw=0, roll=0)))
        #     next_wp = carla.Waypoint(
        #         carla.Transform(carla.Location(x=0, y=0, z=1), carla.Rotation(pitch=0, yaw=0, roll=0)))
        #     return d2wp,d2goal, 0, curr_wp, next_wp, next_wp, vehicle_front
        ...
        d2wp = distance_vehicle(self._target_waypoint,vehicle_transform)
